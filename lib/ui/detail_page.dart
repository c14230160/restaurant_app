          ...
          builder: (context, provider, child) {
            ...
            return switch (state) {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(state.restaurant['address']),
                              ),
                            ],
                          ),
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: state.restaurant['menus']['foods']
                                .map<Widget>(
                                  (food) => Chip(label: Text(food['name'])),
                                )
                                .toList(),
                          ),
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 8,
                            children: state.restaurant['menus']['drinks']
                                .map<Widget>(
              ...
              DetailError() => const Center(
                child: Text('Failed to load restaurant data'),
              ),
            };
          },
        ),
